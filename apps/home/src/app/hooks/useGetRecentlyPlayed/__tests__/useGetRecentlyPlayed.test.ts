import { useGetRecentlyPlayed } from '..';

import { renderHook, wrapper, waitFor } from '../../../utils/testUtils';

describe('components/Header/hooks/useGetRecentlyPlayed', () => {
  it('should return recently played response', async () => {
    const { result } = renderHook(() => useGetRecentlyPlayed(), {
      wrapper,
    });
        ...
        "items": Array [
          Object {
            ...
            "track": Object {
              ...
              "name": "Mine",
              "popularity": 63,
              "preview_url": "https://p.scdn.co/mp3-preview/56c62079c0e3fa7a8d3e44b0f9d1f5797cbb1acb?cid=06a2a95448cb464d870d7d98373601d9",
              "track_number": 1,
              "type": "track",
